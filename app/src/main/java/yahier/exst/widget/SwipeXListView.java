 ...
 * 
 */
public class SwipeXListView extends SwipeMenuListView implements OnScrollListener {
...
//		LogUtil.logE("LogUtil","SwipeXlistView ---onTouchEvent");
		if (mLastY == -1) {
			mLastY = ev.getRawY();
		}
		...
		case MotionEvent.ACTION_MOVE:
			...
			float changeX = rawX > startX ? rawX - startX : startX - rawX;
			float changeY = rawY > mLastY ? rawY - mLastY : mLastY - rawY;
//			LogUtil.logE("LogUtil","changeX-:"+changeX +"--changeY-:"+changeY);
			if (changeX > changeY){
//				LogUtil.logE("LogUtil","SwipeXlistView ---onTouchEvent return false");
...
//		private Animation mRotateDownAnim;
		...
		private AnimationDrawable mRotateDownAnim;
...
//			mRotateDownAnim.setFillAfter(true);
			mRotateUpAnim = (AnimationDrawable) mArrowImageView.getDrawable();
			mRotateDownAnim = (AnimationDrawable) mArrowImageView.getDrawable();
			mRotateUpAnim.setOneShot(true);
		}
