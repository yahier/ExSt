                ...
                postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (mTargetView instanceof AbsListView) {
                            ...
                            absListView.smoothScrollBy(-mFooterOffset, mLoadMoreCompleteToDefaultScrollingDuration);
                        }
                    }
                }, mLoadMoreCompleteDelayDuration);
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                mLastY = y;
                mLastX = x;
                boolean moved = (Math.abs(yInitDiff) > mTouchSlop) && (Math.abs(yInitDiff) > Math.abs(xInitDiff));
