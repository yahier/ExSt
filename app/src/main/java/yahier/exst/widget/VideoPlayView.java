...
import com.stbl.stbl.util.CustomMediaContoller;
 ...
 * Description 播放view
 */
public class VideoPlayView extends RelativeLayout implements MediaPlayer.OnInfoListener, MediaPlayer.OnBufferingUpdateListener, CustomMediaContoller.OnListner {
...
//    private OrientationEventListener orientationEventListener;
    ...
    private void initViews() {
        ...
        mediaController.setOnListener(this);
...
//                    setLayoutParams(layoutParams);
                ...
                mediaController.showPause();//新加
                mediaController.pause();//新加
    ...
    public void pause() {
        LogUtil.logE("VideoPlayView","pause");
    ...
    public void start(String path) {
        ...
        if (mediaController != null) {
            mediaController.setUrl(path);
            mediaController.start();
        }

        //以下代码修改多个视频暂停后播放错乱的问题，
...
//        }
    ...
    //在一些条件下，不显示全屏图标。比如已经是全屏时。
    public void setFullInvisible() {
        view.findViewById(R.id.full).setVisibility(View.INVISIBLE);
    }
...
//            orientationEventListener.enable();
    ...
    public void stop() {
        LogUtil.logE("VideoPlayView","STOP");
        if (mVideoView.isPlaying()) {
            mVideoView.stopPlayback();
        }
    }
...
//        orientationEventListener.disable();
    ...
    OnVideoListener onListener;

    public void setOnListener(OnVideoListener onListener) {
    ...
    public void setOnShowBackListener(OnShowBackListener onShowBackListener){
        if (mediaController != null)
            mediaController.setOnShowBackListener(onShowBackListener);
    }
