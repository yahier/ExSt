 ...
 */
public class DongtaiDetailScrollView extends ScrollView {

    private static final String TAG = "DongtaiDetailScrollView";
    ...
    public DongtaiDetailScrollView(Context context) {
        super(context);
    }

    public DongtaiDetailScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DongtaiDetailScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
