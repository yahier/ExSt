...
public class SwipeMenuLayout extends FrameLayout {
    ...
    private int mMenuStickTo = STICK_TO_SCREEN;
    private int mDownX;
    public SwipeMenuLayout(View contentView, SwipeMenuView menuView) {
        this(contentView, menuView, null, null, STICK_TO_ITEM_RIGHT_SIDE);
    }
    ...
    public SwipeMenuLayout(View contentView, SwipeMenuView menuView, Interpolator closeInterpolator,
        ...
        this(contentView, menuView, closeInterpolator, openInterpolator,STICK_TO_ITEM_RIGHT_SIDE);
    }
    ...
    private void swipe(int dis) {
        ...
        if (mMenuStickTo == STICK_TO_ITEM_RIGHT_SIDE) {
