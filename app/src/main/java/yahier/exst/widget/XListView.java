...
/**
 * An ListView support (PDR) Pull down to refresh, (PUL) Pull up to load more. Implement {@link OnXListViewListener}, and see
 * {@link #onRefreshComplete()} / {@link #onLoadMoreComplete()}. <BR>The default PUL is disabled, you can use
 * {@link #setPullLoadEnable(boolean)} to open it. You also can use {@link #setPullRefreshEnable(boolean)} to
 * close the PDR;
 * 
 */
public class XListView extends ListView implements OnScrollListener {
	...
	// header是否能被拉动
	private boolean isHeaderAbleToPull = true;
	...
	public void setRefreshing(boolean isRefreshing){
		if(isRefreshing){
			...
			mHeaderView.setVisiableHeight(Util.dip2px(getContext(), 60));
	...
	//headerView是否可以被拉动
	public void setHeaderViewIsPull(boolean isHeaderAbleToPull){
		this.isHeaderAbleToPull= isHeaderAbleToPull;
	}
...
//		}
	...
	public void setAutoFresh(){
		...
		updateHeaderHeight(Util.dip2px(getContext(), 60));
		invokeOnScrolling();
		mPullRefreshing = true;
		mHeaderView.setState(XListViewHeader.STATE_REFRESHING);
		if (mOnXListViewListener != null) {
	...
	public void setFooterViewText(String content){
		if (mFooterView != null)
			mFooterView.setTextContent(content);
	}

	public void setFooterViewTextAndListener(String content,OnClickListener onClickListener){
		if (mFooterView != null)
			mFooterView.setTextContent(content);
...
//		public final static int STATE_NODATA = 4;
		...
		/**footerview底部横线显示*/
		public void setTextContentAndShowLine(String content){
			if (mHintView != null){
				mHintView.setVisibility(VISIBLE);
				mHintView.setText(content);
			}
			if (content == null || "".equals(content)){
				vFooterLine.setVisibility(GONE);
			}else{
				vFooterLine.setVisibility(VISIBLE);
			}
		}
...
//				mHintView.setVisibility(View.VISIBLE);
//				mHintView.setText(R.string.xlistview_footer_hint_nothing);				
			} else {
				//mHintView.setVisibility(View.VISIBLE);
		...
		private void initView(Context context) {
			...
			if(moreView != null){
				...
				mLoadingView = (ImageView) findViewById(R.id.iv_arrow);
				mRotateAnim = (AnimationDrawable) mLoadingView.getDrawable();
				mContentView = moreView.findViewById(R.id.xlistview_footer_content);
				mHintView = (TextView) moreView.findViewById(R.id.xlistview_footer_hint_textview);
				vFooterLine = moreView.findViewById(R.id.v_footer_line);
...
//			mRotateDownAnim.setFillAfter(true);
			mRotateAnim = (AnimationDrawable) mArrowImageView.getDrawable();
		}
