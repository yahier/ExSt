...
import com.stbl.stbl.adapter.mine.GoldDetailAdapter;
...
public class GoldDetailFragment extends Fragment {
    ...
    private void initView() {
        ...
        mAdapter = new GoldDetailAdapter(mCurrencyList);
    ...
    private void getBeanCurrencyList() {
        WalletTask.getBeanCurrencyList(1, mLastId, COUNT).setCallback(mActivity, mGetCurrencyListCallback).start();
    }
