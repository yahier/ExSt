...
public class MallOrderAdapter3s extends RCommonAdapter<MallOrder> implements FinalHttpCallback{
	...
	public MallOrderAdapter3s(Activity act, List<MallOrder> mDatas) {
...
//		helper.setText(R.id.order_type_tv, "等待卖家发货");
...
//				replyRefund(item.orderid);
				...
				MallOrderAdapter1.applyRefund(mAct, item.orderid, MallOrderAdapter3s.this);
			}
		});
		// 提醒发货
