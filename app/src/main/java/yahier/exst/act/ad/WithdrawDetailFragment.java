...
import com.stbl.stbl.adapter.ad.WithdrawDetailAdapter;
...
public class WithdrawDetailFragment extends BaseFragment {
    ...
    private void initView() {
        ...
        mAdapter = new WithdrawDetailAdapter(mList);
    ...
    private void getWithdrawDetailList() {
        mTaskManager.start(AdTask.getWithdrawDetailList(mPage, COUNT)
