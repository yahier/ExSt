package yahier.exst.common.tagclound;
...
import com.stbl.stbl.act.home.mall.MallTypeChoiceAct;
...
public class TagCloudLayout extends ViewGroup {
                ...
                public void onClick(View v) {
                    if (mIsSingleSelected) {
                        for (int i = 0; i < getChildCount(); i++) {
                            if (mAdapter instanceof MallTypeChoiceAct.TagBaseAdapter) {
                                if(((MallTypeChoiceAct.TagBaseAdapter)mAdapter).isEmptyItem(i)) continue;
                            }
                            TextView view = (TextView) getChildAt(i);
                            view.setSelected(false);
                            view.setTextColor(UIUtils.getResColor(R.color.gray1));
                        }
                        v.setSelected(!v.isSelected());
                        ((TextView) v).setTextColor(UIUtils.getResColor(R.color.theme_red_bg));
                    }
                    if (mListener != null) {
    ...
    public void setSingleSelected(boolean yes) {
        this.mIsSingleSelected = yes;
    }

    public void setItemSelected(int index, boolean yes) {
        TextView v = (TextView) getChildAt(index);
        v.setSelected(yes);
        v.setTextColor(UIUtils.getResColor(yes ? R.color.theme_red_bg : R.color.gray1));
    }
