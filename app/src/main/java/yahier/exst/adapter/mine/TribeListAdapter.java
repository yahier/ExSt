...
public class TribeListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TribeListAdapter(ArrayList<Ad> list, TribeHeaderView headerView) {
        mList = list;
    ...
    private class LoadMoreViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind() {
            ...
            mLayout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    LogUtil.logE("onClick ",mLoadMoreMode);
                    if (mLoadMoreMode == MODE_HIDE || mLoadMoreMode == MODE_LOADING) return;
                    if (mLoadMoreMode == MODE_TO_ALL || mLoadMoreMode == MODE_FINISH) {
                        mInterface.toAll();
                        return;
                    }
                    if (mInterface != null) {
