...
public class AttendListAdapter extends BaseAdapter implements View.OnClickListener {

    private ArrayList<AttendCon> mList;
    private LayoutInflater mInflater;

    private IAttendListAdapter mInterface;
    private boolean isSelf = false;

    public AttendListAdapter(ArrayList<AttendCon> list, boolean isSelf) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_attend,
                    parent, false);
...
//        holder.mNameTv.setText(user.getNickname());
    ...
    public void setInterface(IAttendListAdapter i) {
        mInterface = i;
    }

    public interface IAttendListAdapter {
