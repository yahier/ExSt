 ...
 */
public class ShoppingCircleCommentAdapter extends BaseAdapter {

    private ArrayList<ShoppingCircleComment> mList;
    private LayoutInflater mInflater;

    private AdapterInterface mInterface;

    public ShoppingCircleCommentAdapter(ArrayList<ShoppingCircleComment> list) {
        mList = list;
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        final ShoppingCircleComment item = mList.get(position);
        final AdUserItem2 user = item.getUser();
        ImageUtils.loadHead(user.getAdimgurl(), holder.mHeadIv);

        holder.mNickTv.setText(user.getAdnickname());
        ...
        final AdUserItem2 lastUser = item.getLastuser();
        if (lastUser != null) {
            ...
            builder.append(" @ " + (lastUser.getAdnickname()));
//            builder.append(" @ " + lastUser.getNickname());
            ...
            ClickableSpan lastClick = new ClickableSpan() {
                ...
                public void onClick(View widget) {
                    ...
                    intent.putExtra("userId", lastUser.getAduserid());
...
//        }
    ...
    public interface AdapterInterface {
        void onItemClick(ShoppingCircleComment item);

        void onClickHead(ShoppingCircleComment item);

        void praiseOrUnpraise(ShoppingCircleComment item);
    }
