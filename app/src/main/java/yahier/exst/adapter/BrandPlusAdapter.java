...
public class BrandPlusAdapter extends OneTypeAdapter<Ad> {
    ...
    public BrandPlusAdapter(BaseActivity activity, ArrayList<Ad> list) {
        super(list);
        mActivity = activity;
        mInflater = LayoutInflater.from(mActivity);
        int width = Device.getWidth() - DimenUtils.dp2px(24);
        int height = Config.uploadAdHeightScale * width / Config.uploadAdWidthScale;
