 ...
 */
public class WithdrawDetailAdapter extends OneTypeAdapter<MoneyFlowItem> {

    private boolean mIsShowNoMore = false;

    public WithdrawDetailAdapter(ArrayList<MoneyFlowItem> list) {
        super(list);
    }
    ...
    protected ViewHolder getViewHolder() {
        return new ViewHolder() {
            ...
            public void init(View v) {
                ...
                mReviewStatusTv = (TextView) v.findViewById(R.id.tv_review_status);
            ...
            public void bind(View v, int position) {
                ...
                mReviewStatusTv.setText(item.exremark);
